...
void dlCLCreateContext(const cl_context_properties * properties,
                ...
                void *user_data, cl_int * errcode_ret, cl_context *contextPtr)
{
	const char *error;
	void *modulePtr;
	cl_context context;
	...
	*contextPtr = (*funcPtr)(properties, num_devices, devices, pfn_notify, user_data, errcode_ret);
...
void dlCLCreateKernel(cl_program program, const char *kernel_name, cl_int * errcode_ret, cl_kernel *kernelPtr)
{
	const char *error;
	void *modulePtr;
...
void dlCLCreateBuffer(cl_context context,
               cl_mem_flags flags, size_t size, void *host_ptr, cl_int * errcode_ret, cl_mem *memPtr)
{
	const char *error;
	void *modulePtr;
