...
do
	echo "***************** matrix = ${matrixSize[j]} * ${matrixSize[j]} *****************" >> ib_bb47_mt_result.txt
	...
	echo "bin/mpiexec.hydra $options ./matrixtrans_sp $inputs  >> ib_bb47_mt_result.txt"
	/home/liyan/mpich2-1.5b1/bin/mpiexec.hydra $options ./vocl_lib/bin/matrixtrans_sp $inputs  >> ib_bb47_mt_result.txt
done
