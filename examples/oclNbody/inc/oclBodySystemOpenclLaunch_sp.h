...
#include "oclBodySystemOpencl_sp.h"
    ...
    void CopyArrayFromDevice(cl_command_queue cmdq, float *host, cl_mem device, cl_mem pboCL,
                             int numBodies, bool bDouble);
    void CopyArrayToDevice(cl_command_queue cmdq, cl_mem device, const float *host,
                           int numBodies, bool bDouble);
