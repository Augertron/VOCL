...
%_mpi.o: %.cpp
	$(CXX) -DPARALLEL  $(CPPFLAGS) $(CXXFLAGS) -c $< -o $@

%_ocl.o: %.cpp
	$(CXX) $(OCL_CPPFLAGS) $(CPPFLAGS) $(CXXFLAGS) $(OCL_CXXFLAGS) -c $< -o $@

%_cuda.o: %.cu
	$(NVCC) ${CUDA_CPPFLAGS} $(CPPFLAGS) $(CXXFLAGS) -c $< -o $@
...
%.o: %.cu
	$(NVCC) ${CUDA_CPPFLAGS} $(CPPFLAGS) $(CXXFLAGS) -c $<

%_mpi.o: %.cu
	$(NVCC) -DPARALLEL ${CUDA_CPPFLAGS} -Xcompiler ""  $(CPPFLAGS) $(CXXFLAGS) -c $< -o $@
