 ...
 * 5.   Same as version 4, with debug information added to get message size
 ****************************************************************************/
int slaveComm;
int slaveCreated = 0;
int np = 1;
...
void checkSlaveProc()
{
	if (slaveCreated == 0)
	{
		...
		elapsedTime = 1000.0 * (t2.tv_sec - t1.tv_sec) + (t2.tv_usec - t1.tv_usec) / 1000.0;
		printf("createSlaveTime = %.3f\n", elapsedTime);
		slaveCreated = 1;
		char hostName[200];
		int  len;
		gettimeofday(&t1, NULL);
		...
		gettimeofday(&t2, NULL);
		elapsedTime = 1000.0 * (t2.tv_sec - t1.tv_sec) + (t2.tv_usec - t1.tv_usec) / 1000.0;
		printf("getProcessorNameTime = %.3f\n", elapsedTime);
		hostName[len] = '\0';
		...
		gettimeofday(&t2, NULL);
		elapsedTime = 1000.0 * (t2.tv_sec - t1.tv_sec) + (t2.tv_usec - t1.tv_usec) / 1000.0;
		printf("registerFinalizeTime = %.3f\n", elapsedTime);
	}
}
				 ...
				 cl_uint *        num_platforms)
{
	...
	//debug---------------------------------------------------
	printf("clGetPlatformIDs = %ld\n", sizeof(tmpGetPlatform));
	//--------------------------------------------------------
               ...
               cl_uint *        num_devices)
{
	...
	//debug---------------------------------------------------
	printf("clGetDeviceIDs= %ld\n", sizeof(tmpGetDeviceIDs));
	//--------------------------------------------------------
                ...
                cl_int *                       errcode_ret)
{
	...
	//debug---------------------------------------------------
	printf("clCreateContext = %ld\n", sizeof(tmpCreateContext));
	//--------------------------------------------------------
	int res;
                     ...
                     cl_int *                       errcode_ret)
{
	...
	//debug---------------------------------------------------
	printf("clCreateCommandQueue = %ld\n", sizeof(tmpCreateCommandQueue));
	//--------------------------------------------------------
                          ...
                          cl_int *          errcode_ret)
{
	...
	//debug---------------------------------------------------
	printf("clCreateProgramWithSource = %ld\n", sizeof(tmpCreateProgramWithSource));
	//--------------------------------------------------------
               ...
               void *               user_data)
{
	...
	//debug---------------------------------------------------
	printf("clBuildProgram = %ld\n", sizeof(tmpBuildProgram));
	//--------------------------------------------------------
               ...
               cl_int *        errcode_ret)
{
	...
	//debug---------------------------------------------------
	printf("clCreateKernel = %ld\n", sizeof(tmpCreateKernel));
	//--------------------------------------------------------
               ...
               cl_int *     errcode_ret)
{
	...
	//debug---------------------------------------------------
	printf("clCreateBuffer = %ld\n", sizeof(tmpCreateBuffer));
	//--------------------------------------------------------
                     ...
                     cl_event *         event)
{
	...
	//debug---------------------------------------------------
	printf("clEnqueueWriteBuffer = %ld\n", sizeof(tmpEnqueueWriteBuffer));
	//--------------------------------------------------------
               ...
               const void * arg_value)
{
	...
	//debug---------------------------------------------------
	printf("clSetKernelArg = %ld\n", sizeof(tmpSetKernelArg));
	//--------------------------------------------------------
                       ...
                       cl_event *       event)
{
	...
	//debug---------------------------------------------------
	printf("clEnqueueNDRangeKernel = %ld\n", sizeof(tmpEnqueueNDRangeKernel));
	//--------------------------------------------------------
                    ...
                    cl_event *          event)
{
	...
	//debug---------------------------------------------------
	printf("clEnqueueReadBuffer = %ld\n", sizeof(tmpEnqueueReadBuffer));
	//--------------------------------------------------------
...
clReleaseMemObject(cl_mem memobj)
{
	...
	//debug---------------------------------------------------
	printf("clReleaseMemObject = %ld\n", sizeof(tmpReleaseMemObject));
	//--------------------------------------------------------
...
clReleaseKernel(cl_kernel kernel)
{
	...
	//debug---------------------------------------------------
	printf("clReleaseKernel = %ld\n", sizeof(tmpReleaseKernel));
	//--------------------------------------------------------
