        ...
        for (i = 0; i < usedDeviceNum; i++) {
            ...
            err |=
                clSetKernelArg(hKernels[i], 3,
                               sizeof(cl_double) * BLOCK_SIZE * (BLOCK_SIZE + 1),
                               (void *) NULL);
            err |=
