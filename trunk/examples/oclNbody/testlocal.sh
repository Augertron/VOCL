...
do
	...
	mpiexec.hydra -np 1 -binding user:0 ./nbody --n=${bodynum[j]} --iter=${iteration[j]}>> logo.txt
	mpiexec.hydra -np 1 -binding user:0 ./nbody --n=${bodynum[j]} --iter=${iteration[j]}>> logo.txt
	mpiexec.hydra -np 1 -binding user:0 ./nbody --n=${bodynum[j]} --iter=${iteration[j]}>> logo.txt
done
...
do
	...
	mpiexec.hydra -np 1 -binding user:8 ./nbody --n=${bodynum[j]} --iter=${iteration[j]}>> logo.txt
	mpiexec.hydra -np 1 -binding user:8 ./nbody --n=${bodynum[j]} --iter=${iteration[j]}>> logo.txt
	mpiexec.hydra -np 1 -binding user:8 ./nbody --n=${bodynum[j]} --iter=${iteration[j]}>> logo.txt
done
