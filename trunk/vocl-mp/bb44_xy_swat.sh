...
do
	echo "***************** sw = ${seqSize[i]}  iteration = ${iteration[i]}$*****************" >> bb44_xy_sw_result.txt
	...
	echo "mpiexec.hydra $options ./swat $inputs  >> bb44_xy_sw_result.txt"
	/home/liyan/mpich2-1.5b1/bin/mpiexec.hydra $options ./vocl_lib/bin/swat $inputs  >> bb44_xy_sw_result.txt
done
