...
do
	echo "***************** matrix = ${matrixSize[j]} * ${matrixSize[j]} *****************" >> ib_bb45_mt_result.txt
	...
	echo "/home/liyan/mvapich2-1.8/bin/mpiexec.hydra $options ./matrixtrans_sp $inputs  >> ib_bb45_mt_result.txt"
	/home/liyan/mvapich2-1.8/bin/mpiexec.hydra $options ./vocl_lib/bin/matrixtrans_sp $inputs  >> ib_bb45_mt_result.txt
done
